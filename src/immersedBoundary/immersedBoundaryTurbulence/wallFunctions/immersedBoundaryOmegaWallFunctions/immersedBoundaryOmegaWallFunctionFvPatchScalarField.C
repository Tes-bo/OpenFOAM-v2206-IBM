...
:
    ibOmegaWallFunctionFvPatchScalarField(p, iF),
...
:
    ibOmegaWallFunctionFvPatchScalarField(p, iF),    // Do not read mixed data
...
:
    ibOmegaWallFunctionFvPatchScalarField(p, iF), // Do not map mixed data.  Set patchType later
    immersedBoundaryFieldBase<scalar>
    (
        p,
        ptf.setDeadValue(),
...
:
    ibOmegaWallFunctionFvPatchScalarField(ptf),
    immersedBoundaryFieldBase<scalar>
    (
        ptf.ibPatch(),
        ptf.setDeadValue(),
...
:
    ibOmegaWallFunctionFvPatchScalarField(ptf, iF),
    immersedBoundaryFieldBase<scalar>
    (
        ptf.ibPatch(),
        ptf.setDeadValue(),
...
void immersedBoundaryOmegaWallFunctionFvPatchScalarField::updateCoeffs()
{
    ...
    // HJ, 20/May/2018
    ibOmegaWallFunctionFvPatchScalarField::updateCoeffs();
...
)
{
    ...
    ibOmegaWallFunctionFvPatchScalarField::evaluate(commsType);
}
...
)
{
    ...
    ibOmegaWallFunctionFvPatchScalarField::manipulateMatrix(matrix);
}
